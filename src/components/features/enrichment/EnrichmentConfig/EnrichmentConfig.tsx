...
export function EnrichmentToolConfig() {
  ...
  const [form, setForm] = useState<any>({
    ...
    enrichmentService: { messageType: "", watcherActive: false, serviceIpAddress: "" },
    exportService: {
  ...
  useEffect(() => {
    ...
    syncSection("lis", "lisConnector", {
      ...
      serviceIpAddress: lisConnector.serviceIpAddress || "",
    });
  }, [lisConnector]);
  ...
  useEffect(() => {
    ...
    syncSection("enrichment", "enrichmentService", {
      ...
      watcherActive: bool(enrichmentService["watcher-active"]),
  ...
  useEffect(() => {
    ...
    syncSection("export", "exportService", {
      ...
      serviceIpAddress: exportService.serviceIpAddress || "",
    });
  }, [exportService]);
  ...
  useEffect(() => {
    ...
    syncSection("hl7", "hl7Messaging", {
      ...
      serviceIpAddress: raw.serviceIpAddress || "",
    });
  }, [hl7Connector]);
  ...
  useEffect(() => {
    ...
    syncSection("email", "emailService", {
      ...
      serviceIpAddress: emailService.serviceIpAddress || "",
    });
  }, [emailService]);
      ...
      {renderDynamicCard(
        ...
        <>
          <div className="col-span-2 flex items-center justify-between px-4 py-3 bg-white border border-gray-200 rounded-lg">
            ...
            <Switch
              checked={!!form.enrichmentService.watcherActive}
              onCheckedChange={(v: boolean) =>
                handleChange("enrichmentService", "watcherActive", v)
              }
