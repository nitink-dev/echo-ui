...
import { CompletedRecordsRow } from "./records/CompletedRecordsRow";

export const StatusPanelCompleted = ({
  statusKey,          // "failed" | "completed" | "inProgress"
  title,              // panel title text
  Icon,               // lucide icon component to show in header
  accentBadgeClass,   // Tailwind classes for the badge color
  data,               // { content, page, size, totalElements, totalPages, hasNext, hasPrevious }
