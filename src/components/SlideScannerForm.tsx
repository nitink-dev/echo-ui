...
import { fetchDicomStores, fetchHospitalMetadata } from '../slices/metadataSlice';
...
export function SlideScannerForm({ scanner, onSave, onCancel, isEdit = false }: SlideScannerFormProps) {
  ...
  // Initialize DICOM store mapping
  useEffect(() => {
    if (dicomStores) {
        ...
        <div className="p-6 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              />
              {errors.deviceSerialNumber && <p className="text-sm text-red-600 flex items-center gap-1">{errors.deviceSerialNumber}</p>}
            </div>
